...
{
    /// <summary>
    /// Interaction logic for PossibilityOfMovePage.xaml
    /// </summary>
    public partial class PossibilityOfMovePage : Page
    {
        ...
        public PossibilityOfMovePage()
        {
            InitializeComponent();
            AssignContent(MakingMoveEnum.PossibilityOfMove);
        }
